...
-----------------------------------------------	
	...
	("en_US",	"LOC_LEADER_CVS_STEPHEN_III_NAME",  "Stephen III"	),
	
-----------------------------------------------
-- UA
-----------------------------------------------	

	("en_US",	"LOC_TRAIT_LEADER_CVS_STEPHEN_III_UA_NAME",  "Athleta Christi"	),
	("en_US",	"LOC_TRAIT_LEADER_CVS_STEPHEN_III_UA_DESCRIPTION",
	"Military units provide [ICON_FAITH] Faith equal to 25% of their cost when created in a city with a Holy Site. Recruiting a Great [ICON_GREATWRITER] Writer, [ICON_GREATARTIST] Artist, or [ICON_GREATMUSICIAN] Musician triggers a random [ICON_CIVICBOOSTED] Inspiration. Great Works of [ICON_GREATWORK_WRITING] Writing, [ICON_GREATWORK_LANDSCAPE] Art and [ICON_GREATWORK_MUSIC] Music in this City receive +2 [ICON_TOURISM] Tourism."	),

-----------------------------------------------
-- Agenda
-----------------------------------------------	

	("en_US",	"LOC_AGENDA_CVS_STEPHEN_III_NAME",	"Ktitor"	),
	("en_US",	"LOC_AGENDA_CVS_STEPHEN_III_DESCRIPTION",	"Likes Civilizations that high faith and culture output. Dislikes those those who convert his cities."	),
	("en_US",	"LOC_DIPLO_KUDO_LEADER_CVS_STEPHEN_III_REASON_ANY",	"(You are strong in faith and culture.)"	),
	("en_US",	"LOC_DIPLO_MODIFIER_CVS_STEPHEN_III_HAPPY",	"Stephen III admires your high faith and culture output"	),
	("en_US",	"LOC_DIPLO_WARNING_LEADER_CVS_STEPHEN_III_REASON_ANY",	"(You converted one of his cities.)"	),
	("en_US",	"LOC_DIPLO_MODIFIER_CVS_STEPHEN_III_UNHAPPY",	"Stephen III is enraged that you converted his cities"	),
...
-----------------------------------------------	
	...
	("en_US",	"LOC_LOADING_INFO_LEADER_CVS_STEPHEN_III",
...
-----------------------------------------------	
	...
	-- First AI Line (ANY)
	("en_US",	"LOC_DIPLO_FIRST_MEET_LEADER_CVS_STEPHEN_III_ANY",
	...
	("en_US",	"LOC_DIPLO_FIRST_MEET_VISIT_RECIPIENT_LEADER_CVS_STEPHEN_III_ANY",
	...
	("en_US",	"LOC_DIPLO_FIRST_MEET_NEAR_INITIATOR_POSITIVE_LEADER_CVS_STEPHEN_III_ANY",
	"Let us proceed onward."	),
	
	-- AI invitation to exchange Capital Information (ANY)
	("en_US",	"LOC_DIPLO_FIRST_MEET_NO_MANS_INFO_EXCHANGE_LEADER_CVS_STEPHEN_III_ANY",
...
-----------------------------------------------	
	...
	-- (HAPPY)
	("en_US",	"LOC_DIPLO_GREETING_LEADER_CVS_STEPHEN_III_HAPPY",
	"Speak freely."	),

	-- (UNHAPPY)
	("en_US",	"LOC_DIPLO_GREETING_LEADER_CVS_STEPHEN_III_UNHAPPY",
	"Tread carefully."	),
...
-----------------------------------------------	
	...
	-- AI Accepts (ANY)
	("en_US",	"LOC_DIPLO_ACCEPT_DELEGATION_FROM_HUMAN_LEADER_CVS_STEPHEN_III_ANY",
	"Very well."	),
	
	-- AI Rejects (ANY)
	("en_US",	"LOC_DIPLO_REJECT_DELEGATION_FROM_HUMAN_LEADER_CVS_STEPHEN_III_ANY",
	"Your delegates are not welcome in Moldavia."	),
	
	-- AI Requests (ANY)
	("en_US",	"LOC_DIPLO_DELEGATION_FROM_AI_LEADER_CVS_STEPHEN_III_ANY",
...
-----------------------------------------------	
	...
	("en_US",	"LOC_DIPLO_ACCEPT_OPEN_BORDERS_FROM_HUMAN_LEADER_CVS_STEPHEN_III_ANY",
	"I'll accept, but be warned, it is said that those who navigate the vast forests of Moldavia are lost to them."	),
	
	-- AI rejects from human (ANY)	
	("en_US",	"LOC_DIPLO_REJECT_OPEN_BORDERS_FROM_HUMAN_LEADER_CVS_STEPHEN_III_ANY",
	"I don't think so."	),
	
	-- AI requests from human (ANY)	
	("en_US",	"LOC_DIPLO_OPEN_BORDERS_FROM_AI_LEADER_CVS_STEPHEN_III_ANY",
...
-----------------------------------------------	
	...
	-- AI accepts from human (ANY)
	("en_US",	"LOC_DIPLO_ACCEPT_DECLARE_FRIEND_FROM_HUMAN_LEADER_CVS_STEPHEN_III_ANY",
	"You honor me. I gladly accept."	),
	
	-- AI rejects from human (ANY)	
	("en_US",	"LOC_DIPLO_REJECT_DECLARE_FRIEND_FROM_HUMAN_LEADER_CVS_STEPHEN_III_ANY",
	"I will not indulge you."	),
	
	-- AI Requests friendship from human (ANY)	
	("en_US",	"LOC_DIPLO_DECLARE_FRIEND_FROM_AI_LEADER_CVS_STEPHEN_III_ANY",
	...
	("en_US",	"LOC_DIPLO_ACCEPT_DECLARE_FRIEND_FROM_AI_LEADER_CVS_STEPHEN_III_ANY",
	"I humbly accept. Together we shall cast the pagans asunder."	),
	
	-- Human rejects AI requests, AI responds (ANY)	
	("en_US",	"LOC_DIPLO_REJECT_DECLARE_FRIEND_FROM_AI_LEADER_CVS_STEPHEN_III_ANY",
	"Doubtful."	),
...
-----------------------------------------------	
	...
	("en_US",	"LOC_DIPLO_MAKE_ALLIANCE_FROM_AI_LEADER_CVS_STEPHEN_III_ANY",
...
-----------------------------------------------	
	...
	-- AI Kudos (ANY)
	("en_US",	"LOC_DIPLO_KUDO_EXIT_LEADER_CVS_STEPHEN_III_ANY",
	"I am inspired by the pious ruler who dares not to secede the importance of their culture."	),
	
	-- AI Warnings (ANY)
	("en_US",	"LOC_DIPLO_WARNING_EXIT_LEADER_CVS_STEPHEN_III_ANY",
...
-----------------------------------------------	
	...
	("en_US",	"LOC_DIPLO_WARNING_TOO_MANY_TROOPS_NEAR_ME_LEADER_CVS_STEPHEN_III_ANY",
	...
	("en_US",	"LOC_DIPLO_WARNING_TOO_MANY_TROOPS_NEAR_ME_AI_RESPONSE_POSITIVE_LEADER_CVS_STEPHEN_III_ANY",
	"You presume an enemy in me? Pity. Luckily for you, my troops are merely passing by."	),
		
	-- AI rejects player's warning for border troops warning (ANY) ~ DECLARES WAR
	("en_US",	"LOC_DIPLO_WARNING_TOO_MANY_TROOPS_NEAR_ME_AI_RESPONSE_NEGATIVE_LEADER_CVS_STEPHEN_III_ANY",
...
-----------------------------------------------	
	...
	("en_US",	"LOC_DIPLO_WARNING_DONT_SETTLE_NEAR_ME_AI_LEADER_CVS_STEPHEN_III_ANY",
	...
	("en_US",	"LOC_DIPLO_WARNING_DONT_SETTLE_NEAR_ME_AI_RESPONSE_POSITIVE_LEADER_CVS_STEPHEN_III_ANY",
	"So be it. We will settle elsewhere."	),
	
	-- Negative AI response to human request (ANY)
	("en_US",	"LOC_DIPLO_WARNING_DONT_SETTLE_NEAR_ME_AI_RESPONSE_NEGATIVE_LEADER_CVS_STEPHEN_III_ANY",
...
-----------------------------------------------	
	...
	("en_US",	"LOC_DIPLO_ACCEPT_MAKE_DEAL_FROM_AI_LEADER_CVS_STEPHEN_III_HAPPY",
	"I am happy to accept your offer."	),
	
	-- AI Accepts Deal (Unhappy)
	("en_US",	"LOC_DIPLO_ACCEPT_MAKE_DEAL_FROM_AI_LEADER_CVS_STEPHEN_III_UNHAPPY",
	"I'm not quite convinced this deal is in my best interests, but I hope you remember this next time."	),

	-- AI Rejects Deal (HAPPY)
	("en_US",	"LOC_DIPLO_REJECT_MAKE_DEAL_FROM_AI_LEADER_CVS_STEPHEN_III_HAPPY",
	"You can do better than that."	),
	
	-- AI Rejects Deal (Unhappy)
	("en_US",	"LOC_DIPLO_REJECT_MAKE_DEAL_FROM_AI_LEADER_CVS_STEPHEN_III_UNHAPPY",
	"Get out of my sight."	),
...
-----------------------------------------------	
	...
	-- From Human
	("en_US",	"LOC_DIPLO_DENOUNCE_FROM_HUMAN_LEADER_CVS_STEPHEN_III_ANY",
	"As iron sharpens iron, so one foe sharpens another. Speak ill of me again and I shall answer with fire."	),
	
	-- From AI
	("en_US",	"LOC_DIPLO_DENOUNCE_FROM_AI_LEADER_CVS_STEPHEN_III_ANY",
...
-----------------------------------------------	
	...
	-- Human Declares War
	("en_US",	"LOC_DIPLO_DECLARE_WAR_FROM_HUMAN_LEADER_CVS_STEPHEN_III_ANY",
	...
	-- AI Declares War
	("en_US",	"LOC_DIPLO_DECLARE_WAR_FROM_AI_LEADER_CVS_STEPHEN_III_ANY",
...
-----------------------------------------------	
	...
	("en_US",	"LOC_DIPLO_MAKE_PEACE_AI_ACCEPT_DEAL_LEADER_CVS_STEPHEN_III_ANY",
	"A truce would not be without merit. I accept."	),
	
	-- AI refuses human
	("en_US",	"LOC_DIPLO_MAKE_PEACE_AI_REFUSE_DEAL_LEADER_CVS_STEPHEN_III_ANY",
	"Mercy is between you and your god."	),
	
	-- AI requests from human
	("en_US",	"LOC_DIPLO_MAKE_PEACE_FROM_AI_LEADER_CVS_STEPHEN_III_ANY",
...
-----------------------------------------------	
	...
	-- AI is Defeated
	("en_US",	"LOC_DIPLO_DEFEAT_FROM_AI_LEADER_CVS_STEPHEN_III_ANY",
	...
	("en_US",	"LOC_DIPLO_DEFEAT_FROM_HUMAN_LEADER_CVS_STEPHEN_III_ANY",
	"Cursed be the ground for our sake. Both thorns and thistles it shall bring forth. For out of the ground I was taken for the dust I am... and to the dust I shall return."	),
...
--------------------------------------------------------------------
	...
	("en_US",	"LOC_PEDIA_LEADERS_PAGE_CVS_STEPHEN_III_QUOTE",
	"Every man has a duty to defend his fatherland."  ),
	
	("en_US",	"LOC_PEDIA_LEADERS_PAGE_CVS_STEPHEN_III_TITLE",
	"Stephen the Great"),
	
	("en_US",	"LOC_PEDIA_LEADERS_PAGE_CVS_STEPHEN_III_SUBTITLE",
	"Ștefan cel Mare, voivode of Moldavia"	),
	
	("en_US",	"LOC_PEDIA_LEADERS_PAGE_LEADER_CVS_STEPHEN_III_CHAPTER_CAPSULE_BODY",
	"Religion is the key to a cultural movement under Stephen III."),
	
	("en_US",	"LOC_PEDIA_LEADERS_PAGE_LEADER_CVS_STEPHEN_III_CHAPTER_DETAILED_BODY",
	...
	("en_US",	"LOC_PEDIA_LEADERS_PAGE_LEADER_CVS_STEPHEN_III_CHAPTER_HISTORY_PARA_1",
	...
	("en_US",	"LOC_PEDIA_LEADERS_PAGE_LEADER_CVS_STEPHEN_III_CHAPTER_HISTORY_PARA_2",
	...
	("en_US",	"LOC_PEDIA_LEADERS_PAGE_LEADER_CVS_STEPHEN_III_CHAPTER_HISTORY_PARA_3",
	...
	("en_US",	"LOC_PEDIA_LEADERS_PAGE_LEADER_CVS_STEPHEN_III_CHAPTER_HISTORY_PARA_4",
	...
	("en_US",	"LOC_PEDIA_BUILDINGS_PAGE_BUILDING_CVS_STEPHEN_III_UI_CHAPTER_HISTORY_PARA_1",	
